...
<body>
    ...
    if (isset($_POST['update'])) {
        ...
        $ticketCount = $_POST['ticketCount']; // New seat count input

        // Correct SQL syntax
        $sql = "UPDATE culturals SET 
                    eventName='$eventName', 
    ...
    if ($result->num_rows > 0) {
        echo '<table border="1">';
        echo '<tr><th>Event ID</th><th>Event Name</th><th>Date and Time</th><th>Venue</th><th>Description</th><th>Participants</th><th>Seat Count</th><th>Actions</th></tr>';
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<td><input type="number" name="ticketCount" value="' . $row['ticketCount'] . '" min="0"></td>'; // New seat count input
            echo '<td>';
